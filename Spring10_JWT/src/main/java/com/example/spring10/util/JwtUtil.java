package com.example.spring10.util;
...
public class JwtUtil {
	 ...
	 *  
	 *  jwt.secret 라는 키값으로 토큰을 발급할때 서명할 key 를 설정했는데 그 문자열을 읽어와야 한다.
	 */
    @Value("${jwt.secret}")
    private String secretKey;
    
    // jwt.expiration 라는 키값으로 토큰의 유효기간을 설정했는데 해당 숫자를 읽어와서 사용한다 
